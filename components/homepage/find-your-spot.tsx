            ...
            <div className="mx-auto max-w-[1480px]">
                ...
                <div className="grid grid-cols-1 gap-5 md:grid-cols-12 md:grid-rows-2">
                    {visibleSpots.map((spot, index) => {
                        const gridClass =
                            index === 0
                                ? "md:col-span-7 md:row-span-2 h-[420px] md:h-full min-h-[420px]"
                                : "md:col-span-5 h-[240px] md:min-h-[220px]"
                        ...
                        return (
                            ...
                            >
                                <a
                                    ...
                                    data-spot-inner
                                    className="relative block h-full w-full overflow-hidden border border-white/15 bg-[#141414] shadow-[0_8px_32px_rgba(0,0,0,0.4)]"
                                ...
                                >
                                    {spot.image ? (
                                        ...
                                        <div className="absolute inset-0 bg-[linear-gradient(135deg,#2a2a2a_0%,#1a1a1a_40%,#0d0d0d_100%)]">
                                            {/* Dot pattern so empty cards still look designed */}
                                            <div className="absolute inset-0 opacity-[0.15] [background-image:radial-gradient(circle_at_1px_1px,rgba(255,255,255,0.4)_1px,transparent_0)] [background-size:20px_20px]" />
                                            {/* Big ghost number */}
                                            <div className="pointer-events-none absolute right-6 top-1/2 -translate-y-1/2 select-none font-black italic text-white/[0.04] text-[clamp(120px,14vw,200px)] leading-none" style={{ fontFamily: "var(--font-ui-sans)" }}>

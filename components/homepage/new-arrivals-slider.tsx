...
export function NewArrivalsSlider({ products }: NewArrivalsSliderProps) {
  ...
  return (
    <section className="relative overflow-hidden bg-[#050505] px-4 py-24 text-white md:px-12">
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,#050505_0%,#0a0a0c_100%)]" />
      <div className="pointer-events-none absolute inset-0 opacity-[0.07] mix-blend-overlay [background-image:radial-gradient(circle_at_20%_20%,rgba(255,255,255,0.9)_0.6px,transparent_0.8px)] [background-size:9px_9px]" />
      ...
      <div className="mx-auto max-w-[1480px]">
        <div className="relative z-10 flex items-end justify-between gap-5">
          <div className="space-y-3">
            <p className="goofy-mono text-[10px] uppercase tracking-[0.3em] text-[#F0B429]">
              JUST LANDED // FRESH WOOD
            </p>
            <h2 className="goofy-display text-[clamp(42px,6vw,80px)] italic leading-[0.84] text-white">
              New Arrivals
            </h2>
          </div>

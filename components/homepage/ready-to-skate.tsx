...
export function ReadyToSkate({
  ...
  return (
    <section
      ref={containerRef}
      className="relative flex h-[50vh] w-full items-center justify-center overflow-hidden border-t border-white/5 bg-transparent md:h-[60vh]"
    >
      ...
      <motion.div style={{ opacity }} className="relative z-10 px-6 text-center">
        ...
        >
          {content.titleLeading} <span className="text-[#F0B429]">{content.titleAccent}</span>
        </h2>

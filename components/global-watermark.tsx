...
export function GlobalWatermark({ text = "GOOFY" }: GlobalWatermarkProps) {
  ...
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_78%_62%,rgba(255,255,255,0.06),transparent_56%)]" />
      ...
      <div
        className="watermark-float absolute bottom-5 left-5 max-w-[min(92vw,960px)] select-none overflow-hidden text-ellipsis whitespace-nowrap text-[rgba(245,239,224,0.16)]"
        style={{

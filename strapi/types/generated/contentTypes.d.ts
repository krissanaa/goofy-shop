...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Product organization for the Goofy Shop catalog';
...
export interface ApiDropEventDropEvent extends Struct.CollectionTypeSchema {
  collectionName: 'drop_events';
  info: {
    description: 'Limited release events and hype countdown entries';
    displayName: 'Drop Event';
    pluralName: 'drop-events';
    singularName: 'drop-event';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiGlobalConfigGlobalConfig extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Site-wide settings: identity, navigation, theme, footer';
  ...
  attributes: {
    ...
    barColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#e52521'>;
    copyrightText: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u00A9 2026 Goofy Shop. All rights reserved.'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    favicon: Schema.Attribute.Media<'images'>;
    isAnnouncementActive: Schema.Attribute.Boolean &
    ...
    shopMenuEnabled: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    shopMenuGodMode: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    shopMenuTrendingLimit: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 1;
        },
    ...
    siteGodMode: Schema.Attribute.Component<'settings.site-god-mode', false>;
    siteName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'GOOFY SHOP'>;
    socialLinks: Schema.Attribute.Component<'shared.social-link', true>;
    soldOutText: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Sold Out'>;
    themeBackground: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'#fafaf8'>;
    themeColorPrimary: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'#e52521'>;
    themeColorSecondary: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'#049cd8'>;
    themeForeground: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'#1a1a2e'>;
    topBarText: Schema.Attribute.JSON;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Homepage layout built from reorderable dynamic zones';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    page_sections: Schema.Attribute.DynamicZone<
      [
        'sections.slideshow',
    ...
    seo_description: Schema.Attribute.Text &
      Schema.Attribute.DefaultTo<'Premium streetwear and skateboard essentials. Limited drops, exclusive collabs, zero compromises.'>;
    seo_title: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'GOOFY SHOP \u2014 Streetwear & Skate'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiLocationsPageLocationsPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Manage the skatepark locations page and menu entry';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    menu_enabled: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    menu_label: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Location'>;
    page_title: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Skate Parks'>;
    parks: Schema.Attribute.Component<'location.park-item', true>;
    publishedAt: Schema.Attribute.DateTime;
    search_placeholder: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Search skate parks'>;
    seo_description: Schema.Attribute.Text &
      Schema.Attribute.DefaultTo<'Explore skate parks and open maps directions.'>;
    seo_title: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Locations | GOOFY SHOP'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Goofy Shop catalog items';
    displayName: 'Product';
    pluralName: 'products';
  ...
  attributes: {
    ...
    drop_events: Schema.Attribute.Relation<
      'manyToMany',
      'api::drop-event.drop-event'
    >;
...
export interface ApiProductsPageProductsPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Settings for /products page grid and controls';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    default_category: Schema.Attribute.String &
    ...
    enable_category_tabs: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    ...
    enable_top_stats: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    enable_view_toggle: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    enable_wishlist: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    initial_favorites_only: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    products_limit: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 100;
          min: 1;
    ...
    promo_text: Schema.Attribute.Text &
      Schema.Attribute.DefaultTo<'Buy 2 get 1 free on selected drops'>;
    publishedAt: Schema.Attribute.DateTime;
    seo_description: Schema.Attribute.Text &
      Schema.Attribute.DefaultTo<'Browse all products, filter by type, sort, and add to cart.'>;
    seo_title: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Products | GOOFY SHOP'>;
    show_hero_scene: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    show_marquee: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::drop-event.drop-event': ApiDropEventDropEvent;
